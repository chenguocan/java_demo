...
<body>
 <div class="contetn">
  ...
  <nav class="nav flex-column col-sm-5 pt-1 pl-3  font-weight-bold ">
    <a class="nav-link " href="${pageContext.request.contextPath}/findAll.html">客户信息查询</a>
    <a class="nav-link active" href="${pageContext.request.contextPath}/add.html">添加客户</a>
  ...
  <div class="msgbox">
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pills-settings" role="tabpanel" aria-labelledby="pills-settings-tab">
          ...
          <form action="${pageContext.request.contextPath}/addCustomer.html" method="post" >       
       
          <div class="input-group mb-3 col-sm-8">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">客户姓名</span>
            </div>
            <input type="text" class="form-control" name="cust_name" placeholder="输入客户姓名" >
          </div>
          <div class="input-group mb-3 col-sm-8">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">客户来源</span>
            </div>
            <input type="text" class="form-control" name="cust_source" placeholder="输入客户来源" >
          </div>
          <div class="input-group mb-3 col-sm-8">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">客户行业</span>
            </div>
            <input type="text" class="form-control" name="cust_industry" placeholder="输入客户行业" >
          </div>
          <div class="input-group mb-3 col-sm-8">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">客户等级</span>
            </div>
            <input type="text" class="form-control" name="cust_level" placeholder="输入客户等级" >
          </div>
          <div class="input-group mb-3 col-sm-8">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">担保人</span>
            </div>
            <input type="text" class="form-control" name="cist_linkman" placeholder="输入担保人">
          </div> 
...
<body>
<form  action="${pageContext.request.contextPath}/addCustomer.html" method="post">
客户名:<input type="text" name="cust_name" />
客户信息来源:<input type="text" name="cust_source" />
客户行业:<input type="text" name="cust_industry" />
客户等级:<input type="text" name="cust_level" />
担保人:<input type="text" name="cist_linkman" />
订单编号:<input type="text" name="cust_code" />
