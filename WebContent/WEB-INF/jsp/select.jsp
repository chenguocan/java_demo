 ...
 <div class="contetn">
  ...
  <div class="msgbox">
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath }/findByid.html" method="post" >
     <div class="form-group mb-1">
    <sapn>订单编号:</sapn>
    </div>
      <div class="form-group mx-sm-3 mb-2">
        <label for="inputPassword2" class="sr-only">订单编号</label>
      <input type="text" name="cust_id" class="form-control" id="inputPassword2" placeholder="请输入订单编号">
      </div>
     <input type="submit" class="btn btn-primary mb-2" value="查询">
    </form>
...
<form action="${pageContext.request.contextPath }/findByid.html" method="post">
输入id:<input type="text" name="cust_id" >
